 ...
 */
final class Version20190404140054 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE concours ADD comment_concours VARCHAR(500) DEFAULT NULL, CHANGE gagnant_id gagnant_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE concours DROP comment_concours, CHANGE gagnant_id gagnant_id INT DEFAULT NULL');
